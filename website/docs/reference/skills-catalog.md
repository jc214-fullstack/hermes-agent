...
| [`discord-gateway-routing`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-discord-gateway-routing) | Configure Hermes Discord routing: mention gates, free-response channels, auto-threading, handoff routes, and per-channel model bindings. | `autonomous-ai-agents/discord-gateway-routing` |
