---
title: "Discord Gateway Routing"
sidebar_label: "Discord Gateway Routing"
...
Configure Hermes Discord routing: mention gates, free-response channels, auto-threading, handoff routes, and per-channel model bindings.
...
| Path | `skills/autonomous-ai-agents/discord-gateway-routing` |
| Version | `1.0.0` |
